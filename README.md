...
```javascript
import arcsine from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-strided-arcsine@v0.2.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-strided-arcsine@v0.2.0-deno/mod.js';
```
